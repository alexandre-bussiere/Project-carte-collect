...
/**
 * <pre>
 * Service pour les messages Hello
 * </pre>
 */
...
public final class MyServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.lib.HelloRequest,
      com.example.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.lib.HelloRequest.class,
      responseType = com.example.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.lib.HelloRequest,
      com.example.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.lib.HelloRequest, com.example.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.lib.HelloRequest, com.example.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.lib.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.example.lib.HelloRequest request,
  ...
  public static final class MyServiceStub
    ...
    /**
     */
    public void sayHello(com.example.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.lib.HelloReply> responseObserver) {
  ...
  public static final class MyServiceBlockingStub
    ...
    /**
     */
    public com.example.lib.HelloReply sayHello(com.example.lib.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.lib.HelloReply> sayHello(
        com.example.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.lib.HelloReply>) responseObserver);
          break;
        default:
